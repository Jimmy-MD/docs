# Configuration de panneaux d’affichage dynamiques

Spatium permet d’intégrer vos panneaux d’affichage dynamique afin d’y afficher le nombre de places disponibles et d’en visualiser l’état dans l’application. Il est également possible de désactiver un panneau dans le cas où il serait nécessaire d’indiquer à vos utilisateurs qu’une section de votre stationnement n’est plus disponible à l’utilisation, pour des raisons de travaux ou d’autres évènements spéciaux.
...
* Toute place faisant partie de deux ou plus ensembles (zones ou groupes) assignés à un même panneau sera compté de façon unique. En effet, Spatium reconnait les doubles pour les éliminer de façon automatique dans les compteurs.

<figure><img src="../../.gitbook/assets/image (59).png" alt=""><figcaption></figcaption></figure>

Une fois le panneau configuré, cliquez sur "Appliquer", sans quoi la modification ne sera pas enregistrée, puis "Sauvegarder", afin de sortir du mode édition.

<figure><img src="../../.gitbook/assets/image (60).png" alt=""><figcaption></figcaption></figure>

En cliquant sur le mode d’édition et en cliquant sur un panneau d’affichage, un dialogue d’édition ouvrira à gauche de l’écran. Ce dialogue permet de modifier les paramètres d’affichage et de consulter les paramètres avancés de la source de données.
