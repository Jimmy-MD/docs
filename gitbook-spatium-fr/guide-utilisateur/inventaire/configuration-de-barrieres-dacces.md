...
La barrière apparaît alors au milieu du plan (tel qu’encadré en rouge dans l’image ci-haut), déjà sélectionnée et un menu flottant apparaît à gauche de l’écran afin de configurer :

* Le nom : Le nom de la barrière sera indiqué au centre de cette dernière sur le plan
* L’identifiant

**Note** : L’identifiant unique vous sera fourni par le manufacturier.

Il est également possible de représenter le sens de la barrière, en entrée ou sortie, en y appliquant une rotation. Le sens des flèches s’adapte donc automatiquement.
